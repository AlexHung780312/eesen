 ...
 *
 */
class ConvolutionalComponent : public TrainableLayer {
 public:
  ...
  Layer* Copy() const { return new ConvolutionalComponent(*this); }
  LayerType GetType() const { return l_Cnn1d; }
  LayerType GetTypeNonParal() const { return l_Cnn1d; }

 ...
 */
class MaxPoolingComponent : public Layer {
 public:
  ...
  Layer* Copy() const { return new MaxPoolingComponent(*this); }
  LayerType GetType() const { return l_MaxPool1d; }
  LayerType GetTypeNonParal() const { return l_MaxPool1d; }
